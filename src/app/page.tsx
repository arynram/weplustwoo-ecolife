...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      {/* Dashboard Section */}
      <section id="dashboard" className="min-h-screen w-full bg-[#022c22] border-t border-white/5 py-24 relative overflow-hidden">
      ...
      {/* Calculator Section */}
      <section id="calculator" className="min-h-screen w-full bg-[#03362a] border-t border-white/5 py-24">
